...
@Client.on_message(filters.command(["setchatphoto", "setgpic"], ".") & filters.me)
...
@Client.on_message(filters.command(["promote", "fullpromote"], ".") & filters.me)
...
@Client.on_message(filters.command("demote", ".") & filters.me)
...
add_command_help(
    ...
    [
        ...
        [f"promote `or` .fullpromote", "Promote someone."],
        ...
        ["setgpic [reply ke image]", "To set a group profile pic"],
    ],
)